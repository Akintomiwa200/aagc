...
export default function HomeScreen() {
    ...
    useEffect(() => {
        ...
        socket.on('initial-data', handleInitialData);
        socket.on('prayer-updated', (count: number) => setPrayerCount(count));
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.quickLinksGrid}>
                        <QuickLink icon={Book} title="Bible" route="/(drawer)/bible" color="#7C3AED" />
                        <QuickLink icon={Heart} title="Giving" route="/(drawer)/giving" color="#EC4899" badge="New" />
                        <QuickLink icon={Zap} title="Live Meet" route="/(drawer)/live-meet" color="#F59E0B" />
                        <QuickLink icon={MessageSquare} title="Prayers" route="/(drawer)/(tabs)/prayers" color="#10B981" badge={prayerCount} />
                        <QuickLink icon={Users} title="Community" route="/(drawer)/friends" color="#3B82F6" badge={activeUsers} />
                        <QuickLink icon={Calendar} title="Events" route="/(drawer)/events" color="#6366F1" badge={todayEvents.length} />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        ...
                        <TouchableOpacity onPress={() => router.push('/(drawer)/events')}>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        ...
                        <TouchableOpacity onPress={() => router.push('/(drawer)/library')}>
