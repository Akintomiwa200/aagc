    ...
    <div className="bg-white w-full">
      <section className="max-w-7xl mx-auto px-6 lg:px-16 py-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Come worship with us in Plateau</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-5 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition"
              >
                Open in Maps
              </a>
            </div>
        ...
        <div className="flex-1 relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
          ...
          {/* Coordinates */}
          <div className="absolute bottom-4 right-4 hidden md:block px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-lg text-xs text-gray-600">
