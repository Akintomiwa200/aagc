      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="relative h-64 lg:h-80 overflow-hidden bg-gradient-to-br from-green-600 to-emerald-700">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/30 mb-4">
                ...
                <span className="text-sm font-medium tracking-wide text-white uppercase">Generosity</span>
              </div>
          ...
          <div className="p-8 lg:p-12 space-y-8">
            ...
            <div className="text-center space-y-4">
              <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
                Every gift makes a difference. Whether you're contributing to tithes and offerings, 
                supporting missions, or helping families in need, your generosity impacts lives and 
                spreads hope throughout our community and beyond.
              </p>
            </div>
        ...
        <div className="text-center mt-8 text-gray-600 text-sm">
          <p>
            ...
            <a href="mailto:giving@church.com" className="text-green-600 hover:text-green-700 font-medium">
              giving@church.com
            </a>
          </p>
        </div>
