...
const sermons: Sermon[] = [
  {
    ...
    duration: "45 min",
    description:
      "Discover how to maintain unwavering faith during life's most challenging seasons.",
    plays: "1.2K",
    image:
  ...
  },
  {
    ...
    duration: "52 min",
    description:
      "Understanding and receiving God's fresh mercies and grace for each new day.",
    plays: "980",
    image:
  ...
  },
  {
    ...
    duration: "58 min",
    description:
      "Building a spiritual legacy that withstands tests of time and trials.",
    plays: "1.5K",
    image:
  ...
  },
  {
    ...
    duration: "49 min",
    description:
      "Transforming your life and home into a sanctuary of continual prayer.",
    plays: "1.1K",
    image:
