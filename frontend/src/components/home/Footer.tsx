  ...
  return (
    <footer className="relative bg-gray-50 overflow-hidden">
      ...
      <div className="absolute top-32 left-0 right-0 flex items-start justify-center pointer-events-none overflow-hidden">
        <div className="text-[20rem] lg:text-[28rem] xl:text-[32rem] font-bold text-gray-200/40 leading-none select-none whitespace-nowrap">
          AAGC
        </div>
      </div>
        ...
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">AAGC</h2>
                <p className="text-sm text-gray-600">Apostolic Army Global Church</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Mobile App Download */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">Get Our App</h3>
